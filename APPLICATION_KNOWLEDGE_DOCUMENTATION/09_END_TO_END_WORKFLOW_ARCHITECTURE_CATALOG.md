...
9. **[`WORKFLOW_ARCHITECTURE_DESIGNS/09_CROSS_ROLE_TENANT_WORKFLOW_DESIGNS.md`](file:///home/admin/UniversityERP/APPLICATION_KNOWLEDGE_DOCUMENTATION/WORKFLOW_ARCHITECTURE_DESIGNS/09_CROSS_ROLE_TENANT_WORKFLOW_DESIGNS.md)**
   - Granular multi-role cross-tenant process flows detailing Role Logins, Screens Seen, Data Entered, Approver Chains, Backend Mutations, and Tenant Transitions (University → Institute → Department → Student/Staff).
